...
function BasicAuthenticator(request, response, loginOptions, logoutOptions) {
  ...
  this._attributes = ["uid", "eppn", "isGuest", "umnDID"];
  this._attributeSource = this.UMN_ATTRS_FROM_HEADERS;
  this._request = request;
  this._response = response;
}

BasicAuthenticator.prototype.UMN_IDP_ENTITY_ID =
  "https://idp2.shib.umn.edu/idp/shibboleth";
BasicAuthenticator.prototype.UMN_TEST_IDP_ENTITY_ID =
  "https://idp-test.shib.umn.edu/idp/shibboleth";
BasicAuthenticator.prototype.UMN_SPOOF_IDP_ENTITY_ID =
  "https://idp-spoof-test.shib.umn.edu/idp/shibboleth";
BasicAuthenticator.prototype.UMN_IDP_LOGOUT_URL =
  "https://login.umn.edu/idp/LogoutUMN";
BasicAuthenticator.prototype.UMN_TEST_IDP_LOGOUT_URL =
  "https://login-test.umn.edu/idp/LogoutUMN";
BasicAuthenticator.prototype.UMN_SPOOF_IDP_LOGOUT_URL =
  "https://login-test-spoof.umn.edu/idp/LogoutUMN";
BasicAuthenticator.prototype.UMN_MKEY_AUTHN_CONTEXT =
  "https://www.umn.edu/shibboleth/classes/authncontext/mkey";
BasicAuthenticator.prototype.UMN_DUO_AUTHN_CONTEXT =
...
BasicAuthenticator.prototype.defaultLogoutOptions = {
  logoutFromIdP: true,
  IdPLogoutURL: BasicAuthenticator.prototype.UMN_IDP_LOGOUT_URL,
};
...
BasicAuthenticator.prototype.buildLoginURL = function (options) {
  var loginURL =
    "https://" + this._request.headers.host + this._handlerURL + "/Login?";
  var params = {};
  ...
  loginURL += new URLSearchParams(params).toString();
...
BasicAuthenticator.prototype.buildLogoutURL = function (options) {
  var logoutURL =
    "https://" + this._request.headers.host + this._handlerURL + "/Logout?";
  var params = {};
  ...
  if (options.logoutFromIdP) {
    params["return"] = options["IdPLogoutURL"];
  ...
  logoutURL += new URLSearchParams(params).toString();
  return logoutURL;
};
...
BasicAuthenticator.prototype.hasSession = function () {
  ...
  var idps = [
    this.UMN_IDP_ENTITY_ID,
    this.UMN_TEST_IDP_ENTITY_ID,
    this.UMN_SPOOF_IDP_ENTITY_ID,
  ];
...
BasicAuthenticator.prototype.hasSessionTimedOut = function (maxAge) {
  ...
  if (authInstant) {
    ...
    return (
      Math.floor(authInstant.getTime() / 1000) + maxAge <=
...
BasicAuthenticator.prototype.loggedInWithMKey = function () {
  if (this.hasSession()) {
    return (
      this.getAttributeValue("Shib-Authentication-Method") ==
      this.UMN_MKEY_AUTHN_CONTEXT
    );
  }
  return false;
};
...
BasicAuthenticator.prototype.getAttributeValue = function (name) {
  ...
  if (this.getAttributeAccessMethod() == this.UMN_ATTRS_FROM_HEADERS) {
    return this._request.headers.hasOwnProperty(name)? this._request.headers[name]
      : null;
  }
};
...
BasicAuthenticator.prototype.setAttributeAccessMethod = function (method) {
  ...
  if (
    [this.UMN_ATTRS_FROM_ENV, this.UMN_ATTRS_FROM_HEADERS].indexOf(method) >= 0
  ) {
